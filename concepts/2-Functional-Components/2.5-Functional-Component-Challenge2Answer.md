# Functional Component Challenge 2 Possible Answer

Here is our solution for the challenge. Both the basic function and arrow function are reusable for you, but you should strive to do something original with the reactstrap if you choose to use it. Our reactstrap code comes straight from the docs:
