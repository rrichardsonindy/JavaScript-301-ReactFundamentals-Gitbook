## Functional Component Challenge Possible Answer

Here is our solution for the challenge. Both the basic function and arrow function are both reusable for you, but you should strive to do something original with the reactsrap if you choose to use it. Our reactstrap code comes straight from the docs:
...
//TODO: UI Improvement? Proof? Text additions? Is this interesting? Maybe put the logo in there?
//Function Syntax
