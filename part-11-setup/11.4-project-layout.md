...
Let's add a few files and directories for the layout of our site. Please add the following to your 'components' directory inside your site folder. Please make sure that your `.js` files are capitalized. These will be React Components, and we are going to follow the convention of keeping Component names capitalized:
